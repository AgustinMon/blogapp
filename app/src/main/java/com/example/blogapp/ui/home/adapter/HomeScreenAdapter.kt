...
class HomeScreenAdapter (private val postList: List<Post>): RecyclerView.Adapter<BaseViewHolder<*>>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<*> {
        // haste este binding gracias a la clase creada por binding = true en features de build gradle
        // PostItemViewBinding es la clase que crea en base al layout xml post_item_view
    ...
    private inner class HomeScreenViewHolder(
        ...
        override fun bind(item: Post) {
            ...
            binding.postTimestamp.text = "item.post_timestamp"
        }
    }
}